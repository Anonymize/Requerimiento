        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-xs-8 col-xs-offset-2 login bg-info">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-primary">Cerrar Requerimiento</h3>
                            <div class="Linea"></div>
                            <br>
                            <div class="col-md-7">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select>
                                            <%
                                                ...
                                                out.println("<option onclick=\"location.href='Seleccion?t=8&g=0'\" selected>Todas</option>");
                                                for (int i = 0; i < gerencias.size(); i++) {
                                                    String sel = "";
                                                    if (req.getGerencia() != 0) {
                                                        sel = ((req.getGerencia() == gerencias.get(i)) ? "Selected" : "");
                                                    }
                                                    out.println("<option " + sel + " onclick=\"location.href='Seleccion?t=8&g=" + gerencias.get(i) + "'\">" + DB.getNombreGerencia(gerencias.get(i)) + "</option>");
                                                }
                                        ...
                                        <select>
                                            <%                                                    
                                                if (req.getGerencia() != 0) {
                                                    ...
                                                    out.println("<option onclick=\"location.href='Seleccion?t=9&d=0'\" selected>Todos</option>");
                                                    for (int i = 0; i < departamentos.size(); i++) {
                                                        String sel = "";
                                                        sel = ((req.getDepartamento() == departamentos.get(i)) ? "Selected" : "");
                                                        out.println("<option " + sel + " onclick=\"location.href='Seleccion?t=9&d=" + departamentos.get(i) + "'\">" + DB.getNombreDepartamento(departamentos.get(i)) + "</option>");
                                                    }
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select>
                                            <%
                                                ...
                                                out.println("<option onclick=\"location.href='Seleccion?t=10&a=0'\" selected>Todos</option>");
                                                for (int i = 0; i < departamentos2.size(); i++) {
                                                    ...
                                                    out.println("<option " + sel + " onclick=\"location.href='Seleccion?t=10&a=" + departamentos2.get(i) + "'\">" + DB.getNombreDepartamento(departamentos2.get(i)) + "</option>");
                                                }
                                            %>
                                        </select>
                                    </div>  
                            ...
                            <div class="col-xs-12 col-md-3">
                                <button type="button" onclick="location.href='Seleccion?t=101'" class="btn btn-primary cienp">Buscar</button>
                            </div>   
                            <br>
                            <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <%
                                                    ...
                                                    if (Req != null) {
                                                            for (int i = 0; i < Req.size(); i++) {
                                                                ...
                                                                out.print("<td>");
                                                                if (Req.get(i).getEstado().equals("A")) {
                                                                    out.print("<button type=\"button\" onclick=\"location.href='Seleccion?t=102&id=" + Req.get(i).getId() + "'\" class=\"btn btn-primary cienp\">Cerrar</button>");
                                                                }else{
                                                                    out.print("Cerrado");
                                                                }
